...
export const TeamPage = () => {
  ...
  return (
    <div className="TeamPage">
      ...
      <PieChart
        data={[
        { title: 'Win', value: team.totalWins, color: '#69eb76' },
        { title: 'Loss', value: team.totalMatches-team.totalWins, color: '#eb736a' },
        // { title: 'No Result', value: team.totalMatches-team.totalWins, color: '#White' },
      ]}
    /></div>
